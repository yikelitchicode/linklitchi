...
const PROJECT_ICON_POOL = [
  ...
  "./assets/icons/project-bloom.svg",
  "./assets/icons/project-comet.svg",
  "./assets/icons/project-confetti.svg",
  "./assets/icons/project-crown.svg",
  "./assets/icons/project-daisy.svg",
  "./assets/icons/project-diamond.svg",
  "./assets/icons/project-fizz.svg",
  "./assets/icons/project-flare.svg",
  "./assets/icons/project-flip.svg",
  "./assets/icons/project-glow.svg",
  "./assets/icons/project-kite.svg",
  "./assets/icons/project-lantern.svg",
  "./assets/icons/project-lolly.svg",
  "./assets/icons/project-mint.svg",
  "./assets/icons/project-moon.svg",
  "./assets/icons/project-orbit.svg",
  "./assets/icons/project-pearl.svg",
  "./assets/icons/project-pinwheel.svg",
  "./assets/icons/project-pixel.svg",
  "./assets/icons/project-rainbow.svg",
  "./assets/icons/project-ribbon.svg",
  "./assets/icons/project-shell.svg",
  "./assets/icons/project-spark.svg",
  "./assets/icons/project-sprout.svg",
  "./assets/icons/project-sun.svg",
  "./assets/icons/project-taffy.svg",
  "./assets/icons/project-wave.svg"
];
